import migrate, { COMMAND_MIGRATE, optionDefinitions as migrateDefinitions } from './migrate.js';  
import dropSchema, { COMMAND_DROP_SCHEMA } from './drop-schema.js';  
...
export { optionDefinitions } from './migrate.js';  

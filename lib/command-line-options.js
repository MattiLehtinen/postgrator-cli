...
const optionDefinitions = (defaults = {}) => [
    {
        ...
        alias: 'r', type: String, typeLabel: 'pg|mysql|mssql|sqlite3', defaultValue: defaults.driver || 'pg',
    },
    {
    ...
    {
        name: 'database', description: 'Database name. In the case of sqlite3, this is the filename, or it defaults to :memory:',
